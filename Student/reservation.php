...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .card{background:var(--white);color:var(--text-main);border-radius:16px;padding:28px;box-shadow:0 4px 20px rgba(91,45,142,0.10);margin-bottom:24px}
        .card-header{font-size:15px;font-weight:700;color:var(--pdark);margin-bottom:20px;display:flex;align-items:center;gap:8px;border-bottom:2px solid var(--border-color);padding-bottom:12px}
        ...
        .field-group input,.field-group select{width:100%;padding:10px 12px;border:1.5px solid var(--border-color);border-radius:10px;font-size:13.5px;font-family:'Inter',sans-serif;color:var(--text-main);outline:none;transition:border-color 0.2s,box-shadow 0.2s;background:var(--input-bg)}
        .field-group input:focus,.field-group select:focus{border-color:var(--purple);box-shadow:0 0 0 3px rgba(91,45,142,0.08);background:var(--white)}
        ...
        /* Reservations table */
        .res-table{width:100%;border-collapse:collapse;color:var(--text-main)}
        ...
        .res-table tbody tr{background:var(--white)}
        .res-table tbody tr:nth-child(even){background:var(--white);opacity:0.95}
        .res-table tbody tr:hover{background:var(--bg)!important;color:var(--text-main)}
        .res-table tbody td{padding:9px 14px;font-size:13px;border-bottom:1px solid var(--border-color)}
        ...
        /* PC GRID CSS */
        .pc-grid { display: grid; grid-template-columns: repeat(10, 1fr); gap: 6px; margin-top: 8px; max-height: 200px; overflow-y: auto; padding: 5px; background:var(--input-bg); border:1px solid var(--border-color); border-radius: 8px; }
