...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        :root{--purple:#5B2D8E;--pdark:#3D1A6E;--plight:#7B4BB8;--gold:#F0B429;--gdark:#C88F0A}
        body{
            font-family:'Inter',sans-serif;
            min-height:100vh;
            background: linear-gradient(160deg, #f5f0ff 0%, #ede5f8 55%, #f9f3e0 100%);
            display:flex;
        ...
        .dropdown-menu a:hover{background:#f5f0ff;color:var(--purple)!important}
        ...
        .school-name{font-size:11px;color:#888;letter-spacing:1.2px;text-transform:uppercase;text-align:center}
        ...
        .input-wrap i{position:absolute;left:13px;top:50%;transform:translateY(-50%);color:#aaa;font-size:14px}
        .field input{width:100%;padding:11px 12px 11px 38px;border:1.5px solid #ddd;border-radius:10px;font-size:14px;font-family:'Inter',sans-serif;color:#333;background:#faf8ff;outline:none;transition:border-color 0.2s,box-shadow 0.2s}
        .field input:focus{border-color:var(--purple);box-shadow:0 0 0 4px rgba(91,45,142,0.1);background:#fff}
        .forgot{text-align:right;margin-top:-10px;margin-bottom:20px}
        .forgot a{font-size:12px;color:#999;text-decoration:none}
        ...
        .back-link a{font-size:12.5px;color:#aaa;text-decoration:none}
